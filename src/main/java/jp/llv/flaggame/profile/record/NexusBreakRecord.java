 ...
 */
public class NexusBreakRecord extends ScoreRecord {

    public NexusBreakRecord(UUID game, double x, double y, double z, UUID player, double score) {
        super(game, x, y, z, player, score);
    }

    public NexusBreakRecord(UUID game, UUID player, Location location, double score) {
        super(game, player, location, score);
    }

    @Deprecated
    public NexusBreakRecord(UUID game, Player player, double score) {

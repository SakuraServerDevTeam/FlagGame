 ...
 * @author toyblocks
 */
public class LogoutRecord extends PlayerRecord {

    public LogoutRecord(UUID game, double x, double y, double z, UUID player) {
        super(game, x, y, z, player);
    }

    public LogoutRecord(UUID game, Player player) {
        super(game, player);
    }

    /*package*/ LogoutRecord(Document base) {
        super(base);
    }

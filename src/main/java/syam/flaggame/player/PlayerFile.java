...
public class PlayerFile {
    ...
    public PlayerFile(final String name) {
        ...
        String filename = FlagGame.getInstance().getDataFolder() + System.getProperty("file.separator") + "userData" + System.getProperty("file.separator") + name + ".yml";
    ...
    public boolean load() {
        if (!file.exists()) {
            ...
            saved = false;
            if (!save()) { throw new IllegalArgumentException(logPrefix + "Could not create player data!"); }
        }

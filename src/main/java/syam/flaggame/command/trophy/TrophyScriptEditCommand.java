 ...
 * @author toyblocks
 */
public class TrophyScriptEditCommand extends TrophyEditCommand<NashornTrophy> {
    ...
    public TrophyScriptEditCommand(FlagGameAPI api) {
        super(
                api,
                1,
                "<line> [script] <- edit a line of trigger script",
                FlagTabCompleter.builder()
                        .forArg(0).suggestConst()
                        .forOtherArgs().suggestConst(JS_WORDS)
                        .create(),
                NashornTrophy.class,
                "script edit",
                "sce"
